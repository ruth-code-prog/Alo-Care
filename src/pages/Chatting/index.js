...
//     const chatID = `${dataOurstaff.data.uid}_${user.uid}`;
//     const chatPartnerID = `${user.uid}_${dataOurstaff.data.uid}`;

//     const urlFirebase = `chatting/${chatID}/allChat/${setDateChat(today)}`;
//     const urlPartnerFirebase = `chatting/${chatPartnerID}/allChat/${setDateChat(
//       today
//     )}`;
...
//       .then(() => {
//         setChatContent("");
//         Fire.database().ref(urlPartnerFirebase).push(data);
